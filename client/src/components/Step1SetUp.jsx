                    ...
                    <div className='space-y-5'>
                        {[
                            ...
                            <motion.div key={index}
                                ...
                                className='flex items-center xspace-x-4 bg-white p-4 rounded-xl shadow-sm cursor-pointer'>
                                {item.icon}
                ...
                >
                    ...
                    <div className='space-y-6'>
                        ...
                        <select value={mode}
                            ...
                            className='w-full py-3 px-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transtion'>
                            ...
                            <motion.div
                                ...
                                {resumeFile && (
                                    <motion.button
                                        ...
                                        className='mt-4 bg-gray-900 text-white px-5 py-2 rounded-lg hover:bg-gray-800 taransition'
                                    >
                                ...
                                {skills.length > 0 && (
                                    <div>
                                        ...
                                        <div className='flex flex-wrap gap-2'>
                                            {skills.map((s,i) => (
                                                <span className='bg-green-100 text-gree-700 px-3 py-1 rounded-full text-sm' key={i}>{s}</span>
                                            ))}
                                        </div>
                                    </div>
                                )}
