    ...
    useEffect(() => {
        ...
        const runIntro = async () => {
            if (isIntroPhase) {
                ...
                await speakText("For the fair assessment, please do not use any external resources during the interview.")
                ...
                if (currentIndex === questions.length - 1) {
                    await speakText("Allright, this one might be a bit more challenging.");
                }
