...
function Pricing() {
  ...
  const plans = [
    {
      ...
      price: "₹0",
      credits: 100,
      description: "Perfect for beginners starting interview peparation.",
      features: [
    ...
    },
    {
      ...
      price: "₹500",
      credits: 650,
      description: "Best value for serious job prparation.",
      features: [
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 py-16 px-6'>
      <div className='max-w-6xl mx-auto mb-14 flex items-satrt gap-4'>
      ...
      <div className='grid mid:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto'>
        {plans.map((plan) => {
