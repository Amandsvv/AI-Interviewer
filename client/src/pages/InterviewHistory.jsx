    ...
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-emerald-50 py-10'>
      <div className='w-[90vw] lg:w-[70vw] max-w-[90%] mx-auto'>
        <div className='mb-10 w-full  flex items-start gap-4 flex-wrap'>
          ...
          <div>
            <h1 className='text-3xl font-bold text-gray-800 flex-nowrap'>Interview Hstory</h1>
            <p className='text-gray-500 pt-2'>Track your past interviews and performance reports.</p>
          </div>
        </div>
                ...
                <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
                  ...
                  <div className='flex-items-center gap-6'>
                    ...
                    <span className={`px-4 py-1 rounded-full text-xs font-medium ${
                      item.status === "completed" ? "bg-emerald-100 text-emerald-700" : "bg-yellow-100 text-yellow-700"
