        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              <p className='mb-4'>Practice Inteview with</p>
              ...
              [
                {
                  ...
                  desc: "AI ajusts difficulty based on selected job role."
                },
                {
                  icon: <BsMic size={24} />,
                  step: "STEP 2",
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc: "Project-specific questions basedd on uploaded resume."
                  },
                  {
                    image: pdfImg,
                    icon: <BsFileEarmarkText size={20} />,
                  ...
                  },
                  {
                    ...
                    desc: "Track progress with performance graphs and topic analytics."
                  }
                ].map((item, index) => (
                  <motion.div key={index}
                    initial={{ opacity: 0, y: 30 }}
                    ...
                    className='bg-white border border-gray-200 rounded-3xl p-8 sahdow-sm hover:shadow-xl transition-all'>
